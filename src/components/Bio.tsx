...
function Bio() {
  return (
    <div id='about'>
      ...
      <p className='paragraph'>I am a computer science student with a passion for building websites and exploring all things computer-related. From a young age, I was fascinated by the endless possibilities of technology, and my curiosity has only grown stronger over the years.</p>
